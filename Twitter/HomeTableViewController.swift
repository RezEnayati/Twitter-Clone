...
class HomeTableViewController: UITableViewController {
    ...
    @objc func loadTweets(){
        ...
        TwitterAPICaller.client?.getDictionariesRequest(url: myUrl, parameters: myPrams) { (tweets: [NSDictionary]) in
            ...
            print("Could not reterive tweets!")
        }
    }
